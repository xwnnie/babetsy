...
def seed_products():
    ...
    product4 = Product(name="Harper 4-in-1 Convertible Crib",
                       price=1298, quantity=1000000, description="Make space in your bedroom or in their nursery for our elegant and refined Harper 4-in-1 Convertible Crib. Expertly crafted from sustainably sourced wood, this sturdy piece offers everything baby needs for years of sweet dreams. What's more, this adaptable design easily converts into a cozy toddler bed with the optional conversion kit. We love it paired with the matching nightstand and nursery dresser.", image_url="https://assets.pkimgs.com/pkimgs/ab/images/dp/wcm/202222/0163/harper-4-in-1-convertible-crib-o.jpg", category_id=2)
    
    product5 = Product(
        name="Super Soft Animal Baby Hooded Towel & Washcloth Set", price=45, quantity=1000000, description="Let their favorite animals join in on their clean routine with these animal-inspired sets. Made of pure cotton terry with a cotton sateen binding, these luxuriously soft bathtime pieces are delicate and smooth on their skin.", image_url="https://assets.pkimgs.com/pkimgs/ab/images/dp/wcm/202205/0179/super-soft-animal-baby-hooded-towel-washcloth-set-2-o.jpg", category_id=4)
    
    product6 = Product(name="Baby Lion Framed Art",
                       price=59, quantity=1000000, description="Turn their nursery walls into a gallery of art that inspires the imagination. Awash is soft neutrals against a white background, this lion brings playful, classic style to their space.", image_url="https://assets.pkimgs.com/pkimgs/ab/images/dp/wcm/202209/0116/baby-lion-framed-art-o.jpg", category_id=5)
